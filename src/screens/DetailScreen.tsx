    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.productView}>
                ...
                <Text style={[{marginTop: 20, fontWeight: "bold", color: Colors.pink}]}>Description</Text>
                <Text style={styles.productDescription}>{product.description}</Text>
            </View>
            <TouchableOpacity style={styles.addToCart}>
                <Ionicons name="add-sharp" size={12} color={Colors.white}/>
                <Text style={[{marginLeft: 10, color: Colors.white, fontSize: 12}]}>Add To Cart</Text>
            </TouchableOpacity>
        </View>
    );
}
